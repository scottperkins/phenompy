...
#
# ax.plot(np.linspace(10.,2500,1e5),fitted_hanford_noise(np.linspace(10.,2000,1e5)),label='fitted Hanford Noise',linestyle='--')
#
# ax.plot(np.linspace(1e-3,100,1e5),decigo_noise(np.linspace(1e-3,100,1e5)),label='DECIGO',linestyle='-.')
#
